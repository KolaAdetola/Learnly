  ...
  return (
    <div className='px-4 my-0 w-full flex items-center justify-between h-10' >
        ...
        <div className="form-input flex w-full flex-1 resize-none overflow-hidden rounded-lg text-[#140821] focus:outline-0 focus:ring-0 border-none bg-[#e7daf6] focus:border-none h-12 placeholder:text-[#6c2db4] px-4 pr-2 text-base font-normal leading-normal items-center gap-2 py-5">
          <textarea name="" className="form-input w-full py-2 px-1 custom-scrollbar h-10 text-[#140821] focus:outline-0 focus:ring-0 border-none bg-inherit focus:border-none placeholder:text-[#6c2db4] resize-none text-base font-normal leading-normal scroll-pb-5" placeholder="Type a message" id=""  type="text"></textarea>
