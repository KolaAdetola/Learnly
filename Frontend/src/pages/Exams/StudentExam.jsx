...
import useGetExam from "../../hooks/useGetExams"; // Corrected hook import

const StudentExam = () => {
  const { examCode } = useParams(); // Get examCode from URL
  ...
  if (!exam) return <p>Exam is not found</p>;
  ...
  return (
    <div>
      ...
      <p><strong>Total Marks:</strong> {exam.examTotalMarks}</p>
